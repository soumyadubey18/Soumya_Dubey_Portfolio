...
import { FaHtml5, FaCss3Alt, FaReact, FaNodeJs, FaGitAlt, FaJira, FaUsers, FaLightbulb, FaClock, FaSearchPlus } from "react-icons/fa";
import { SiTailwindcss, SiTypescript, SiNextdotjs, SiPostgresql, SiExpress, SiMongodb, SiFirebase, SiSwagger } from "react-icons/si";
    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-[#3E2723]">
        <div className="pb-12 text-center md:text-left">
          <p className="text-5xl font-extrabold inline border-b-8 border-[#C5A059]/10 rounded-sm">Professional Experience</p>
          <p className="py-8 text-lg text-[#5D4037] max-w-2xl">My career journey and professional contributions in the software industry.</p>
        </div>

        <div className="w-full mb-20">
          {experience.map(({ id, role, company, duration, points }) => (
            <div key={id} className="p-8 rounded-3xl bg-white border border-[#EADBC8] shadow-sm hover:shadow-xl transition-all duration-500 mb-8">
        ...
        <div className="pb-12 text-center md:text-left">
          <p className="text-5xl font-extrabold inline border-b-8 border-[#C5A059]/10 rounded-sm">Technical Skills</p>
