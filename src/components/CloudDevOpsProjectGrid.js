    ...
    switch (project.id) {
      ...
      case "careerbridge":
        return (
          <div className="rounded-xl bg-[#03060C] border border-slate-800 p-3.5 font-mono text-[11px] select-none text-slate-300">
            <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-800/80 text-[10px] text-slate-500">
              <span className="text-purple-400">RBAC AUTHORIZATION MATRIX</span>
              <span className="text-emerald-400">JWT AUTH</span>
            </div>
            <div className="flex flex-wrap gap-1 text-[10px] pt-1">
              <span className="px-2 py-0.5 rounded bg-red-950/50 border border-red-800/50 text-red-300">ADMIN</span>
              <span className="px-2 py-0.5 rounded bg-blue-950/50 border border-blue-800/50 text-blue-300">TRAINER</span>
              <span className="px-2 py-0.5 rounded bg-amber-950/50 border border-amber-800/50 text-amber-300">PLACEMENT</span>
              <span className="px-2 py-0.5 rounded bg-emerald-950/50 border border-emerald-800/50 text-emerald-300">STUDENT</span>
            </div>
          </div>
        );
          ...
          >
            ...
            <div className="p-6 sm:p-7 space-y-4">
              ...
              <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800/60">
                {project.points.slice(0, 2).map((pt, pIdx) => (
                  <div key={pIdx} className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300 leading-snug">
            ...
            <div className="px-6 py-4 border-t border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-950/30 flex items-center justify-between gap-3 mt-auto">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-sky-500 hover:text-sky-400 transition-colors"
              >
